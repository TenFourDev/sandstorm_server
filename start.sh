...
Insurgency/Binaries/Linux/InsurgencyServer-Linux-Shipping \
    ...
    -mutators=Flashlight_Shadows,MapVoteLabels,MoreAmmoPlus,FullyLoaded,AdminCommands,JoinLeaveMessage,PingExt,NoRestrictedArea,StallCounter,ImprovedAI,CapCount \
