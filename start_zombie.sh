...
Insurgency/Binaries/Linux/InsurgencyServer-Linux-Shipping \
    ...
    -mutators=Flashlight_Shadows,MapVoteLabels,MoreAmmoPlus,FullyLoaded,AdminCommands,JoinLeaveMessage,PingExt,StallCounter,ImprovedAI_2,WG3,MoreAmmo,Reloads,Bolts,Quickdraw,ZombiesLite,CapCount,Healthy \
